...
Ojo: `DIR_PARTES` debe ser un directorio propio. Las partes de v1 están indexadas
...
#
# Se arrastra el último año disponible (2020), que es lo que ya hace el sistema
# en producción: `mapa_riesgo_hoy.py:66` lee `popdens_2020` fijo para predecir
# en 2026. Arrastrarlo aquí alinea el entrenamiento con la inferencia; usar el
# valor real de 2021-22 (si existiera) habría creado un desajuste
