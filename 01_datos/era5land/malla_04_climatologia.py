...
la misma fuente, no que la fuente sea la mejor.
...
import config
from malla_02_descarga import AREA, VARIABLES, a_diario, abre
...
def main():
    ...
    np.savez_compressed(config.salida("clim_fwi_nodos.npz"),
    ...
    print(f"\nGuardado: {config.salida('clim_fwi_nodos.npz')}")
