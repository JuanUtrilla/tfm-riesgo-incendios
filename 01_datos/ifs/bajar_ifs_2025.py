...
rango 25-may -> 01-nov de 2025 son 12 tramos, unas 67.000 unidades: no cabe
en un día. Por eso es reanudable por nodo y espera ante el 429 hasta que la
cuota se renueve a medianoche UTC.
...
def esperar_turno():
    ...
    # runners de GitHub, así que no compiten. No se espera.
    return
