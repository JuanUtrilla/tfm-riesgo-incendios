...
`donde_dia_effis_r10.ubj` —el que sirve la cadena y puntúan los jueces— queda
intacto.
...
· Mismos hiperparámetros y mismo nº de árboles. `dos_18` ya QUITA el early
  stopping y fija `n_estimators = N_ARBOLES = 441` justamente para que las
  comparaciones no se confundan con el nº de árboles. Aquí se hereda esa
