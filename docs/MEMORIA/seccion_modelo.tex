...
puntuación de la celda sino en la intensidad de la temporada. Se probaron tres remedios ---estratificar por
mes, acortar la ventana y descomponer en el producto
$P(\text{día grande})\times P(\text{celda}\mid\text{día grande})$--- y los tres
fallan por la misma razón: condicionada a día grande, la punta de julio de 2022
alcanza el 14,95\,\% frente a un máximo de 2,05\,\% en los años de calibración,
siete veces por encima. No es un problema de esquema de calibración sino de
extrapolación. Lo que se sostiene es que la probabilidad por celda está bien
calibrada en condiciones típicas ---contra la mediana de julio, 0,53\,\%, el
modelo dice en torno al 0,9\,\%--- y que en una temporada de récord se queda
corta en un orden de magnitud; declararlo es más útil que ocultarlo.
