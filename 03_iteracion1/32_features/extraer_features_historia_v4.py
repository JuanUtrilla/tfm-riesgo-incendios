...
Entrada:  dataset/muestra_maestra_v4.parquet
Salida:   dataset/features_historia_v4.parquet (id_muestra + features)
...
Historial de fuego (EGIF 2008-2022, coords proyectadas a EPSG:3035):
...
RUTA_MAESTRA = "/home/charredgem/Desktop/Master/TFM_fuego/dataset/muestra_maestra_v4.parquet"
RUTA_EGIF = "/home/charredgem/Desktop/Master/TFM_fuego/egif_civio_2026-08.csv"
...
RUTA_SALIDA = "/home/charredgem/Desktop/Master/TFM_fuego/dataset/features_historia_v4.parquet"
...
def main() -> None:
    ...
    egif = egif.dropna()
    egif = egif[(egif["fecha"].dt.year >= 2008) & (egif["fecha"].dt.year <= 2022)]
    ...
    print(f"EGIF 2008-2022 para historial: {len(egif)} incendios", flush=True)
