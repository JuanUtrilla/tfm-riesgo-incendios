...
RUTA_MAESTRA = f"{DATOS}/dataset/muestra_maestra_v4.parquet"
RUTA_EGIF = f"{DATOS}/egif_civio_2026-08.csv"
RUTA_FIRMS = f"{DATOS}/firms_iberia_2015_2024.parquet"
RUTA_WGLC = f"{DATOS}/rayos_data/wglc/wglc_timeseries_30m_daily.nc"
RUTA_SALIDA = f"{DATOS}/dataset/features_historia_v4.parquet"
