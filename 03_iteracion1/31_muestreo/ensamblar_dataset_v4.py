...
Entradas: dataset/muestra_maestra_v4.parquet
          dataset/features_cubo_v4.parquet
          dataset/features_historia_v4.parquet
Salida:   dataset/dataset_modelo_v4.parquet  (tabla final de entrenamiento)
...
def main():
    maestra = pd.read_parquet(f"{DIR}/muestra_maestra_v4.parquet")
    cubo = pd.read_parquet(f"{DIR}/features_cubo_v4.parquet")
    historia = pd.read_parquet(f"{DIR}/features_historia_v4.parquet")
    ...
    df.to_parquet(f"{DIR}/dataset_modelo_v4.parquet", index=False)
    print(f"\nGuardado {DIR}/dataset_modelo_v4.parquet "
