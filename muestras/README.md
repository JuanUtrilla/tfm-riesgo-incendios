...
48 MB para que el repo funcione recién clonado, sin bajar los 44 GB de fuentes
originales. `config.entrada()` cae aquí cuando no encuentra el dato ni en
`salida/` ni en `TFM_DATOS`.
...
Es el mes con el que se hizo la primera comparación seria entre producción y la
